...
<body>
	...
	<div class="form-control position-fixed p-1 rental-box">
		...
		<table class="table-bordered form-control">
			...
			<tr class="rental_schedule" hidden="hidden">
				<td colspan="1">
					대여 : <input class="form-control rental_start" type="date" name="rentalDate" min="${rentalDate}" value="${rentalDate}">
 				</td>
				<td colspan="1">
					반납 : <input class="form-control rental_end" type="date" name="dueDate" min="${dueDate}" value="${dueDate}">
 				</td>
 			</tr>
 			<tr class="rental_schedule" hidden="hidden">
				<td colspan="2">
	...
	<form id="article" action="/test/rental/article" method="post" hidden>
		<input name="car_idx"/>
